...
/**
 * Stores the Twig configuration and renders layouts.
 *
...
class Environment
{
     ...
     *
     *  * charset: The charset used by the layouts (default to UTF-8).
     *
     *  * cache: An absolute path where to store the compiled layouts,
     ...
     *
     *  * strict_variables: Whether to ignore invalid variables in layouts
     *                      (default to false).
     *
     ...
     *                                     an absolute path to the compiled layouts,
     ...
     *
     * This method should not be used as a generic way to load layouts.
     *
     ...
     * \Twig\TemplateWrapper, and an array of layouts where each is tried to be loaded.
     *
     * @param string|TemplateWrapper|array $names A template or an array of layouts to try consecutively
     *
     * @throws LoaderError When none of the layouts can be found
     * @throws SyntaxError When an error occurred during compilation
     */
    public function resolveTemplate($names): TemplateWrapper
    {
        ...
        throw new LoaderError(sprintf('Unable to find one of the following layouts: "%s".', implode('", "', $names)));
    }
